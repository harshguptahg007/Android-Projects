...
public class PetProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        //set notification URI on the cursor, so we know what content URI was the cursor created for.
        //if the data at this URI changes, then we need to update the cursor.
        cursor.setNotificationUri(getContext().getContentResolver(),uri);
        //doing this sets the notification URI for any cursor returned by the query method.
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        //the 2nd parameter is optional content observer
    ...
    public String getType(Uri uri) {
        ...
        // stored at the input Uri. This String is known as the MIME type, which can also be referred to as content type.
