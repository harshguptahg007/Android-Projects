...
public class MainActivity extends AppCompatActivity {
    ...
    private FingerprintManager fingerprintManager;//this will help us to check that the device
    // has a finger print scanner or not
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Check 1 : Android Version should be greater than or equal to Marshmallow
        //Check 2 : Device has a finger print scanner or not
        //Check 3 : You have permission to use fingerprint scanner in the app
    ...
    private void generateKey() {
        ...
        } catch (KeyStoreException | CertificateException |IOException | NoSuchAlgorithmException | InvalidAlgorithmParameterException
